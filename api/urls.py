...
urlpatterns = [
    ...
    path('routes/multiple_routes_to_destination/', find_multiple_routes_to_destination, name='multiple-routes-to-destination'),
    path('routes/routes_with_switch_station/', find_routes_with_switch_station_view, name='routes-with-switch-station'),    path('', TemplateView.as_view(template_name='landing-page.html')),
